...
It trades a feature-rich architecture with flexible ABI and dynamic resource
management for a simplified implementation that facilitates safety and security
verification.
